...
boats = Boat.create(user_id: user.id, name: 'My Kids', price: 70, location: 'Bahamas', image: "https://res.cloudinary.com/dv59x91lc/image/upload/v1590145475/IMG_9654_pjfjmk.jpg")
boats = Boat.create(user_id: user.id, name: 'Virgin Mary', price: 55, location: 'Florida', image: "https://res.cloudinary.com/dv59x91lc/image/upload/v1590145651/ALL-ABOUT-YOU-Anchored-3-1030x687_b6q4fs.jpg")
boats = Boat.create(user_id: user.id, name: 'Seagull', price: 450, location: 'Tong Sai', image: "https://res.cloudinary.com/dv59x91lc/image/upload/v1590145652/PHOENIX-2-1_lmwi7y.jpg")
